...
"background-color: rgb(200, 200, 200);"));
        ...
        label_ocr_result = new QLabel(widget_6);
        label_ocr_result->setObjectName("label_ocr_result");
        sizePolicy.setHeightForWidth(label_ocr_result->sizePolicy().hasHeightForWidth());
        label_ocr_result->setSizePolicy(sizePolicy);
        QFont font3;
        font3.setPointSize(20);
        label_ocr_result->setFont(font3);
        label_ocr_result->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);"));

        verticalLayout_3->addWidget(label_ocr_result);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_5->setText(QCoreApplication::translate("MainWindow", "\350\257\206\345\210\253\347\273\223\346\236\234", nullptr));
        label_ocr_result->setText(QCoreApplication::translate("MainWindow", "--", nullptr));
    } // retranslateUi
